...
const statusStyles = {
  ...
  arriving: "bg-blue-50 text-blue-700 border border-blue-100",
      ...
      <section className="bg-stone-900 text-stone-50 border-b border-amber-900/20">
        <div className="container max-w-7xl mx-auto px-6 py-16 md:py-24">
          ...
          <p className="text-stone-400 text-sm max-w-md font-medium leading-relaxed">
            Monitor the progress of your architectural materials from our
            warehouse to your project site.
          </p>
        </div>
      </section>
      ...
      <main className="flex-grow py-12 md:py-16">
        <div className="container max-w-5xl mx-auto px-6 space-y-8">
          ...
          <div className="flex items-center justify-between border-b border-stone-200 pb-4">
            ...
            <Link
              to="/order-history"
              className="text-[10px] uppercase tracking-[0.2em] font-bold text-amber-700 hover:underline"
            >
              View Past Logs
            </Link>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-24 border-2 border-dashed border-stone-200 rounded-2xl">
              ...
              <p className="text-stone-500 text-sm">
                You have no shipments currently in transit.
              </p>
              <Link
                to="/products"
                className="mt-5 inline-block text-amber-700 font-bold uppercase text-[10px] tracking-[0.2em] hover:underline"
              >
                Browse Products
              </Link>
            </div>
            ...
            orders.map((order) => {
              ...
              return (
                <div
                  key={order._id}
                  className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden group hover:border-amber-200 hover:shadow-md transition-all duration-300"
                >
                  {/* Status Header */}
                    ...
                    <div className="flex items-center gap-3">
                      <span
                        className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${
                          statusStyles[rawStatus] || statusStyles.pending
                        }`}
                      >
                    ...
                    <div className="md:col-span-4 flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-bold text-stone-900 text-sm">
                          {itemsCount}{" "}
                          {itemsCount > 1 ? "Items" : "Industrial Item"}
                        </p>
