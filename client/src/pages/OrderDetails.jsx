...
import { jsPDF } from "jspdf"; // Change to curly braces
...
export default function OrderDetails() {
  ...
  const generateInvoice = () => {
    try {
      ...
      // --- 1. Top Branding Header (Inscape Layers) ---
      doc.setFillColor(28, 25, 23); // Dark stone color from your brand
      ...
      // Our Details (From your footer data)
      doc.setFontSize(10);
      doc.setFont("helvetica", "bold");
      doc.text("FROM:", 14, 60);
      ...
      // Payment Summary Box
      doc.setFillColor(252, 251, 247); // Light stone-50
      ...
      // --- 5. Footer (Trust Badges & Terms) ---
      doc.setDrawColor(200);
      doc.line(14, 272, 196, 272); // Footer line
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-stone-50">
        <div className="text-center space-y-4">
          ...
          <Link
            to="/order-history"
            className="text-amber-700 font-bold uppercase tracking-widest text-xs underline"
          >
            Return to Logs
          </Link>
        </div>
        ...
        <div className="container max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <Button
              ...
              className="border-stone-700 text-stone-300 hover:bg-stone-800 hover:text-white gap-2 uppercase tracking-widest text-[10px] h-12 px-6"
            >
              {isGenerating ? (
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden shadow-sm">
              <div className="px-8 py-6 border-b border-stone-100 flex items-center justify-between bg-stone-50/50">
                <h3 className="text-sm font-serif font-bold italic text-stone-600">
                  Product Manifest
                </h3>
              ...
              <div className="divide-y divide-stone-100">
                {order.items.map((item, idx) => (
                  <div
                    key={idx}
                    className="p-8 flex flex-col md:flex-row gap-6 items-center group"
                  >
  ...
  return (
    <div className="flex flex-col items-center gap-2 relative z-10">
      ...
      <div className="text-center">
        <p
          className={`text-[10px] font-bold uppercase tracking-widest ${active ? "text-stone-900" : "text-stone-400"}`}
        >
          {label}
        </p>
