...
import {
  ...
  Mail, Phone, MapPin, ArrowRight, ShieldCheck, CreditCard,
} from "lucide-react";
      ...
      <div className="container max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 pb-14 border-b border-stone-200">
          <div className="lg:col-span-2">
            ...
            <div className="flex max-w-md gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-stone-200 focus:outline-none focus:border-amber-500 transition-all bg-white text-sm"
              />
              <button className="bg-stone-900 text-white px-5 py-3 rounded-xl hover:bg-amber-700 transition-colors flex items-center gap-2 text-sm font-medium">
          ...
          <div className="flex flex-col justify-center gap-3 bg-amber-50 p-6 rounded-xl border border-amber-100">
            <div className="flex items-center gap-3 text-amber-900">
              ...
              <span className="font-semibold text-sm">Industry Certified Quality</span>
            </div>
            <p className="text-xs text-stone-500 leading-relaxed">
              All products meet rigorous durability standards and come with full manufacturer warranties.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 pt-14">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-serif text-lg font-bold text-stone-900">Inscape Layers</h3>
            </div>
          ...
          {/* Collections */}
          <div>
            <h4 className="font-semibold text-stone-900 mb-5 uppercase text-xs tracking-widest">
              Collections
            </h4>
        ...
        <div className="border-t border-stone-200 mt-14 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-5 text-stone-400">
            ...
            <Link to="/privacy" className="text-[10px] uppercase tracking-widest hover:text-stone-700 transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-[10px] uppercase tracking-widest hover:text-stone-700 transition-colors">
              Terms
            </Link>
          </div>
        </div>
