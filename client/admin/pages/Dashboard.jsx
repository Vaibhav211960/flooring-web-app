  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white border border-stone-200 rounded-2xl p-8 min-h-[300px] flex items-center justify-center relative overflow-hidden">
          <div className="absolute top-6 left-8">
            <h3 className="font-serif text-lg font-bold text-stone-900">Revenue Analytics</h3>
            <p className="text-[10px] uppercase tracking-widest text-stone-400 font-bold mt-0.5">
              Performance overview
            </p>
          </div>
          <p className="text-stone-300 font-serif italic text-sm">Chart coming soon...</p>
